...
// function guessTheNumber(maxNumber) {
//   let addPoints = 100;
//   let computerGuess = Number(Math.floor(Math.random() * maxNumber));

//   let recursiveAcyncreadLine = () => {
//     readline.question(`Guess the number (0 - ${maxNumber}): `, number => {
